...
namespace utils {
  ...
  public:
    ...
    FileError(const clib::Text& s): std::runtime_error(
      (clib::Text("Couldn't read file: ") + s).raw()
    ) {}
    FileError(const char* s): FileError(clib::Text(s)) {}
  };
    
  class EncryptionError : public std::runtime_error {
  public:
    EncryptionError(): std::runtime_error("Couldn't encrypt/decrypt file.") {}
    EncryptionError(const clib::Text& s): std::runtime_error(
      (clib::Text("Couldn't encrypt/decrypt file: ") + s).raw()
    ) {}
    EncryptionError(const char* s): EncryptionError(clib::Text(s)) {}
  };
  ...
  public:
    ...
    InvalidCipherTypeError(const clib::Text& s): EncryptionError(s.raw()) {}
  };
  ...
  public:
    ...
    NoFileOpenError(const clib::Text& s): std::runtime_error(s.raw()) {}
  };
  ...
  public:
    ...
    PasswordModifyError(const clib::Text& s): std::runtime_error(s.raw()) {}
  };
  ...
  public:
    ...
    MathError(const clib::Text& s): std::invalid_argument(s.raw()) {}
  };
}
