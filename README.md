...
която пак има същия ламбда проблем, чието отстраняване намерих за ненужно. Методът използва ANSI код за да изчиства екрана, което не работи във всеки терминал.
